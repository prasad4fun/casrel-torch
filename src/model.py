...
class Casrel(nn.Module):
    ...
    def get_encoded_text(self, token_ids, mask):
        ...
        encoded_text = self.bert_encoder(token_ids.long(), attention_mask=mask)[0]
        return encoded_text
    ...
    def forward(self, data):
        ...
        sub_head_mapping = data['sub_start'].unsqueeze(1)
        # [batch_size, 1, seq_len]
        sub_tail_mapping = data['sub_end'].unsqueeze(1)
        # [batch_size, seq_len, rel_num]
